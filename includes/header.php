...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/svg+xml" href="/agenda/assets/img/favicon.svg">
    <!-- Intégration de Bootstrap pour un style rapide (version locale) -->
    <link href="/agenda/assets/vendor/bootstrap/bootstrap.min.css" rel="stylesheet">
    <!-- Font Awesome pour les icônes (version locale) -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <!-- Bootstrap Icons -->
    <link rel="stylesheet" href="/agenda/assets/vendor/bootstrap-icons/bootstrap-icons.css">
    <!-- Google Fonts -->
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&display=swap" rel="stylesheet">
    <!-- Animate.css pour les animations (version locale) -->
    <link rel="stylesheet" href="/agenda/assets/vendor/animate/animate.min.css">
