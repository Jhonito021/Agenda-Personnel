    ...
    <div class="col-md-12">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <?php else: ?>
                            <button type="submit" name="ajouter" class="btn btn-primary">
                                <i class="bi bi-plus-circle"></i> Ajouter la tâche
                            </button>
                            <a href="index.php?page=taches" class="btn btn-secondary">
                                <i class="fas fa-times"></i> Annuler
                            </a>
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0"><i class="bi bi-list-ul"></i> Liste des tâches</h5>
                <div>
                    <a href="index.php?page=taches&action=ajouter"<?php if (!empty($templates)): ?>
                        <div class="mb-4">
                            <div class="fw-bold mb-2"><i class="bi bi-magic"></i> Mes templates de tâche :</div>
                            <div class="d-flex flex-wrap gap-2">
                                <?php foreach ($templates as $tpl): ?>
                                    <button type="button" class="btn btn-outline-secondary btn-sm template-btn" data-template='<?php echo htmlspecialchars($tpl['contenu'], ENT_QUOTES); ?>'>
                                        <i class="bi bi-files me-1"></i><?php echo htmlspecialchars($tpl['nom']); ?>
                                    </button>
                                    <form method="post" action="" style="display:inline;">
                                        <input type="hidden" name="template_id" value="<?php echo $tpl['id']; ?>">
                                        <button type="submit" name="supprimer_template" class="btn btn-outline-danger btn-sm" onclick="return confirm('Supprimer ce template ?');"><i class="bi bi-trash"></i></button>
                                    </form>
                                <?php endforeach; ?>
                            </div>
                        </div>
