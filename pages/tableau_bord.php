    ...
    <div class="col-md-6 mb-4">
        <div class="card h-100">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0"><i class="bi bi-list-task"></i> Tâches à faire</h5>
    ...
    <div class="col-md-6 mb-4">
        <div class="card h-100">
            <div class="card-header">
                <h5 class="mb-0"><i class="bi bi-pie-chart"></i> Statistiques</h5>
            </div>
            <div class="card-body">
                ...
                <!-- Événements à venir -->
                <h6 class="mt-4"><i class="bi bi-calendar-week"></i> Événements à venir (7 jours)</h6>
            ...
            <div class="card-footer">
                <a href="index.php?page=emploi_temps" class="btn btn-primary">
                    <i class="bi bi-calendar-plus"></i> Gérer l'emploi du temps
                </a>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-md-12 mb-4">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="bi bi-lightbulb"></i> Suggestions pour votre planning</h5>
            </div>
            <div class="card-body">
                <div class="alert alert-info">
                    <h6><i class="bi bi-info-circle"></i> Conseil du jour</h6>
                    <?php
                    $conseils = [
