    ...
    <div class="col-md-12">
        ...
        <div class="row">
                    ...
                    <div class="card-header">
                        <h5 class="mb-0">
                            <?php if ($action === 'modifier' && $categorie_a_modifier): ?>
                                <i class="bi bi-pencil-square"></i> Modifier la catégorie
                            <?php else: ?>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0"><i class="bi bi-list-ul"></i> Liste des catégories</h5>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    <?php if (count($categories) > 0): ?>
                                        <?php foreach ($categories as $categorie): ?>
                                            <tr>
                                                <td>
                                                    <span class="d-inline-block rounded" style="width: 25px; height: 25px; background-color: <?php echo $categorie['couleur']; ?>"></span>
                                                </td>
                                                <td><?php echo htmlspecialchars($categorie['nom']); ?></td>
                                                <td><?php echo !empty($categorie['type']) ? htmlspecialchars($categorie['type']) : 'Non défini'; ?></td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        <a href="index.php?page=categories&action=modifier&id=<?php echo $categorie['id']; ?>" class="btn btn-sm btn-outline-primary">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <a href="index.php?page=categories&action=supprimer&id=<?php echo $categorie['id']; ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette catégorie ?');">
...
<script>
    // Script pour mettre à jour la prévisualisation de la couleur
